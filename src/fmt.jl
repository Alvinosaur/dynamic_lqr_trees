...
mutable struct FMTree
    ...
    function FMTree(s_init::Vec4f, s_goal::Vec4f, N, world)
        ...
        # generate N-1 other samples so with x_init, we have N samples in total
        for n = 1:N-2
            while(true)
        ...
        # return a new instance of FMT Tree with the class members specified in the right order
        new(s_init, s_goal,
